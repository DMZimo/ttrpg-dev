...
export function parseUuid(uuid, {relative}={}) {
  ...
  if ( (parts[0] === "Compendium") && !CONST.COMPENDIUM_DOCUMENT_TYPES.includes(parts[3]) && (parts[3] !== "Folder") ) {
    const type = game.packs.get(`${parts[1]}.${parts[2]}`)?.documentName;
    parts.splice(3, 0, type);
    if ( type ) uuid = parts.join(".");
  }
