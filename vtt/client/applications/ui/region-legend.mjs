...
export default class RegionLegend extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  #prepareRegion(region) {
    ...
    return {
      ...
      elevationLabel: hasElv ? `[${Number.isFinite(region.elevation.bottom) ? region.elevation.bottom : "&minus;&infin;"}, `
        + `${Number.isFinite(region.elevation.top) ? region.elevation.top : "&plus;&infin;"}]` : "",
