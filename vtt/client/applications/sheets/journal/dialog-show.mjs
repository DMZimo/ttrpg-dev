...
export default class ShowToPlayersDialog extends HandlebarsApplicationMixin(DialogV2) {
  ...
  static async #onFormSubmit(event, form, formData) {
    ...
    if ( imageOnly ) return Journal.showImage(this.document.src, {
      users,
      title: this.document.name,
      caption: showImageCaption ? this.document.caption : undefined,
      showTitle: showImageTitle,
      uuid: this.document.uuid
    });
    return Journal.show(this.document, { users, force: true });
  }
}
