import {EventEmitterMixin, Semaphore} from "@common/utils/_module.mjs";
 ...
 */
export default class ApplicationV2 extends EventEmitterMixin() {
  ...
  *_headerControlButtons() {
  ...
  #callHooks(hookName, hookArgs, parentClassHooks) {
    ...
    for ( const cls of classes ) {
      ...
      Hooks.callAll(hookName.replace("{}", cls.name), this, ...hookArgs);
    }
  }
