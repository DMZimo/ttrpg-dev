 ...
 * @property {number} [yearZero=0]                        The year which is considered year 0 in the calendar.
 ...
 * @property {number} leapStart                           The year number of the first leap year. On or after yearZero.
 ...
 * @property {number|null} startMonth                     The ordinal month in which the season starts.
 * @property {number|null} startDay                       The day of the month on which the season starts.
 * @property {number|null} endMonth                       The ordinal month in which the season ends.
 * @property {number|null} endDay                         The day of the month on which the season ends.
 */
