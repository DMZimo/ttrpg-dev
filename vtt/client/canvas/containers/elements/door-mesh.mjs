 ...
 * @import {CanvasAnimationData, CanvasAnimationAttribute} from "../../animation/canvas-animation.mjs";
 */
...
export default class DoorMesh extends PrimarySpriteMesh {
   ...
   * @type {DoorAnimationConfiguration}
   */
  #animation;
  ...
  #getClosedPosition({flip, sort}={}) {
    ...
    const textureGridSize = this.object.document?.getFlag("core", "textureGridSize") ?? 200;
    ...
    return {x: point.x, y: point.y, elevation, sort, rotation, scaleX, scaleY, tint: 0xFFFFFF};
  }
